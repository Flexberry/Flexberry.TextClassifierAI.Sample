...
moduleForAcceptance('[AGAT] Acceptance | i i s reports text classifier ai report l');

test('testing i-i-s-reports-text-classifier-ai-report-l', function(assert) {
  visit('/i-i-s-reports-text-classifier-ai-report-l');
