...
moduleForAcceptance('[AGAT] Acceptance | i i s reports text classifier ai report type l');

test('testing i-i-s-reports-text-classifier-ai-report-type-l', function(assert) {
  visit('/i-i-s-reports-text-classifier-ai-report-type-l');
